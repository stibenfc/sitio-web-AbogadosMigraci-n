...
if (joinUsBtn) {
    joinUsBtn.addEventListener('click', (e) => {
        e.preventDefault();
        showSection('pqrs'); // Cambiado para dirigir al formulario de contacto/PQRS
    });
}

const messageTextarea = document.getElementById('pqrs-message');
const charCountSpan = document.getElementById('pqrs-char-count');
